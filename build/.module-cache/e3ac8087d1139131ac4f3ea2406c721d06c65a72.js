  ...
  render: function() {
    return (
        React.createElement("div", {id: "Card"}, 
          ...
          React.createElement(QuestionPanel, {questionData: this.props.data}), 
          React.createElement(AnswerPanel, {data: this.props.data})
        )
    );
  }
});
...
React.render(
    React.createElement(Card, {questionData: app.survey[0]}),
