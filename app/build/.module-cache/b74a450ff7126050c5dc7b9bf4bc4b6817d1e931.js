...
var QuestionPanel = React.createClass({displayName: "QuestionPanel",
  render: function() {
    var data = {data}
    return (
        React.createElement("div", {id: "QuestionPanel", data: data}, 
          React.createElement("div", {id: "questionTag", data: data}
          ), 
  ...
  render: function() {
    return (
        React.createElement("div", {id: "Card"}, 
          ...
          React.createElement(QuestionPanel, {data: data}), 
          React.createElement(AnswerPanel, {data: data})
        )
    );
  }
});
