...
var QuestionPanel = React.createClass({ displayName: "QuestionPanel",
  ...
  handleCheckboxClick: function handleCheckboxClick(clickedOptionTag, event) {
    ...
    console.log(nkoreaTest.Card.state.questionSerial);
    console.log(nkoreaTest.survey.length);

    if (nkoreaTest.Card.state.questionSerial === nkoreaTest.survey.length) {
    ...
    if (clickedOptionTag === this.props.data.correctOptionTag) {
      nkoreaTest.totalScore += nkoreaTest.totalScore;
    }
...
var ScorePage = React.createClass({ displayName: "ScorePage",
  render: function render() {
    return React.createElement("h1", null, nkoreaTest.totalScore);
  }
});

React.render(React.createElement(Card, { surveyData: nkoreaTest.survey }), document.getElementById("content"));

//# sourceMappingURL=5579ecd743287f535b887e1c3bdcca006e4e0249-compiled.js.map