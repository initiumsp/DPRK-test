...
var Card = React.createClass({ displayName: "Card",
  ...
  render: function render() {
    return React.createElement("div", { id: "Card", surveyData: this.props.surveyData }, React.createElement(Banner, null), this.state.showAnswer ? React.createElement(AnswerPanel, { data: this.props.surveyData[this.state.answerSerial] }) : null, React.createElement(QuestionPanel, { data: this.props.surveyData[this.state.questionSerial] }), React.createElement("button", null, "Show Answer"));
  }
});
...
//# sourceMappingURL=90e15785a4f850038132a17e59c8b33cec2d53bf-compiled.js.map