    ...
    if (this.props.data.optionContainsImage) {} else {
      optionBoxes = this.props.data.options.map(function (option) {
        return React.createElement("div", { className: "optionBox", key: option.optionTag }, React.createElement("label", null, React.createElement("input", { type: "checkbox",
          ...
          ref: "checkbox" + option.optionTag }), React.createElement("span", { className: "optionTag" }, option.optionTag), React.createElement("span", { className: "optionText" }, option.optionText), React.createElement("span", { className: "CorrectnessSign" }, this.getCorrectnessSign(option.optionTag))));
      }, this);
    }
...
var Card = React.createClass({ displayName: "Card",
  ...
  clearAllCheckboxes: function clearAllCheckboxes() {
    var checkbox = React.findDOMNode("checkboxA");
...
//# sourceMappingURL=a40aca7e36afa7cacc7d35aebc81fc0b83f07c57-compiled.js.map