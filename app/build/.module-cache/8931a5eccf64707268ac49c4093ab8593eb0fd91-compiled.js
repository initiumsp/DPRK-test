...
var Card = React.createClass({ displayName: "Card",
  ...
  render: function render() {
    app.Card = this;
    return React.createElement("div", { id: "Card", surveyData: this.props.surveyData }, React.createElement(Banner, null), this.state.showAnswer ? React.createElement(AnswerPanel, { data: this.props.surveyData[this.state.answerSerial], className: "fadein" }) : null, React.createElement(QuestionPanel, { data: this.props.surveyData[this.state.questionSerial] }));
  }
});
...
//# sourceMappingURL=8931a5eccf64707268ac49c4093ab8593eb0fd91-compiled.js.map