...
var QuestionPanel = React.createClass({ displayName: "QuestionPanel",
  ...
  handleCheckboxClick: function handleCheckboxClick(clickedOptionTag, event) {
    ...
    console.log(nkoreaTest.questionSerial);
    console.log(nkoreaTest.survey.length);

    // All questions answered: display total score
    if (nkoreaTest.questionSerial === nkoreaTest.survey.length) {
...
//# sourceMappingURL=7e4dbbf9da74b158f7a026dbaabc215248b9bb36-compiled.js.map