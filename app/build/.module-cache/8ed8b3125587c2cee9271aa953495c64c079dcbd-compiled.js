  ...
  render: function render() {
    ...
    if (this.props.data.optionContainsImage) {} else {
      optionBoxes = this.props.data.options.map(function (option) {
        return React.createElement("div", { "class": "optionBox", handleCheck: this.handleCheck }, React.createElement("label", null, React.createElement("input", { type: "checkbox",
          name: option.optionTag,
          onChange: this.props.handleCheck }), React.createElement("span", { "class": "optionTag" }, option.optionTag), React.createElement("span", { "class": "optionText" }, option.optionText)), React.createElement("button", { onClick: this.props.handleCheck }, "Button"));
      });
    }
...
//# sourceMappingURL=8ed8b3125587c2cee9271aa953495c64c079dcbd-compiled.js.map