...
var QuestionPanel = React.createClass({ displayName: "QuestionPanel",
  ...
  render: function render() {
    var optionBoxes;
    this.handleCheckboxChange = function (event) {};
    if (this.props.data.optionContainsImage) {} else {
      optionBoxes = this.props.data.options.map(function (option) {
        return React.createElement("div", { "class": "optionBox" }, React.createElement("label", null, React.createElement("input", { type: "checkbox",
          ...
          onChange: app.handleCheckboxChange }), React.createElement("span", { "class": "optionTag" }, option.optionTag), React.createElement("span", { "class": "optionText" }, option.optionText)));
      });
    }
...
//# sourceMappingURL=02bbafc682dc6ddea62c260465986a05803aa22c-compiled.js.map