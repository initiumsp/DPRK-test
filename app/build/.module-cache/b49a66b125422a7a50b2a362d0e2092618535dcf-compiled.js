  ...
  render: function render() {
    ...
    if (this.props.data.optionContainsImage) {} else {
      optionBoxes = this.props.data.options.map(function (option, i) {
        return React.createElement("div", { className: "optionBox" }, React.createElement("input", { type: "checkbox",
...
//# sourceMappingURL=b49a66b125422a7a50b2a362d0e2092618535dcf-compiled.js.map