    ...
    if (this.props.data.optionContainsImage) {} else {
      optionBoxes = this.props.data.options.map(function (option) {
        return React.createElement("div", { "class": "optionBox", handleCheck: this.handleCheck }, React.createElement("label", null, React.createElement("input", { type: "checkbox",
          ...
          onChange: this.handleCheck }), React.createElement("span", { "class": "optionTag" }, option.optionTag), React.createElement("span", { "class": "optionText" }, option.optionText)), React.createElement("button", { onClick: this.handleCheck }, "Button"));
      });
    }
...
//# sourceMappingURL=cac699f859f88ce8779dde7e987159e386df937c-compiled.js.map