    ...
    if (this.props.data.optionContainsImage) {} else {
      optionBoxes = this.props.data.options.map(function (option) {
        return React.createElement("div", { className: "optionBox", key: option.optionTag }, React.createElement("label", null, React.createElement("input", { type: "checkbox",
          ...
          onChange: this.handleCheckboxClick.bind(this, option.optionTag) }), React.createElement("span", { className: "optionTag" }, option.optionTag), React.createElement("span", { className: "optionText" }, option.optionText), React.createElement("span", { className: "CorrectnessSign" }, this.getCorrectnessSign(option.optionTag))));
      }, this);
    }
...
var Card = React.createClass({ displayName: "Card",
  ...
  clearAllCheckboxes: function clearAllCheckboxes() {
    var QuestionPanel = React.findDOMNode(this.refs.QuestionPanel);
    console.log(QuestionPanel);
    console.log("clearAllCheckboxes triggered.");
  },
  ...
  render: function render() {
    ...
    return React.createElement("div", { id: "Card", surveyData: this.props.surveyData }, React.createElement(Banner, null), React.createElement(QuestionPanel, { data: this.props.surveyData[this.state.questionSerial],
      ref: "QuestionPanel" }), this.state.showAnswer ? React.createElement(AnswerPanel, { data: this.props.surveyData[this.state.answerSerial],
      clearAllCheckboxes: this.clearAllCheckboxes }) : null);
  }
});
...
//# sourceMappingURL=08dee9ac2393d3524c98c7fa223cb18c359a4717-compiled.js.map