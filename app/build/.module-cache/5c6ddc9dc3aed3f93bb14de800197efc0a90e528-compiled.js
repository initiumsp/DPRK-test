...
var ScorePage = React.createClass({ displayName: "ScorePage",
  render: function render() {
    ...
    return React.createElement("div", { id: "ScorePage" }, "你的總分是：", nkoreaTest.totalScore, comment);
  }
});

React.render(React.createElement(Card, { surveyData: nkoreaTest.survey }), document.getElementById("content"));

//# sourceMappingURL=5c6ddc9dc3aed3f93bb14de800197efc0a90e528-compiled.js.map