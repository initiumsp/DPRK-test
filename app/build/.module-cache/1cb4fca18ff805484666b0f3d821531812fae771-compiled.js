...
var Card = React.createClass({ displayName: "Card",
  ...
  render: function render() {
    return React.createElement("div", { id: "Card", surveyData: this.props.surveyData }, React.createElement(Banner, null), this.state.showAnswer ? React.createElement(AnswerPanel, { data: this.props.surveyData[this.state.answerSerial] }) : null, React.createElement(QuestionPanel, { data: this.props.surveyData[this.state.questionSerial] }), React.createElement("button", { onClick: function onClick(event) {
        alert("ho");
        this.setState({ questionSerial: 1 });
      }
    }, "Show Answer"));
  }
});
...
//# sourceMappingURL=1cb4fca18ff805484666b0f3d821531812fae771-compiled.js.map