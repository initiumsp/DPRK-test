...
var QuestionPanel = React.createClass({ displayName: "QuestionPanel",
  ...
  handleCheckboxClick: function handleCheckboxClick(optionTag) {
    alert(optionTag);
    this.props.setCardState({ showAnswer: true });
  },
...
var Card = React.createClass({ displayName: "Card",
  ...
  render: function render() {
    return React.createElement("div", { id: "Card", surveyData: this.props.surveyData }, React.createElement(Banner, null), React.createElement(QuestionPanel, { data: this.props.surveyData[this.state.questionSerial],
      setCardState: this.setState }), this.state.showAnswer ? React.createElement(AnswerPanel, { data: this.props.surveyData[this.state.answerSerial] }) : null);
  }
});
...
//# sourceMappingURL=4f1bd6cb64354ac5570f66e74203b7edc293be19-compiled.js.map