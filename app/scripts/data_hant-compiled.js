...
nkoreaTest.text = {
  ...
  marketingInfoboxInnerHTML: "<span style=\"color: red\"><strong>「端」APP：</strong>" + "<a href=\"https://theinitium.com/download/\" style=\"color: red\" target=\"_blank\">https://theinitium.com/download</a></span>" + "<br />" + "<strong>「端」網：</strong><a href=\"https://theinitium.com/\" target=\"_blank\">theinitum.com</a>" + "<br />" + "<strong>「端」報：</strong>香港發行，逢週五出版" + "<br />" + "<strong>端app：（中國內地用戶）</strong><a href=\"https://theinitium.com/download/?force_cn=true\" target=\"_blank\">" + "https://theinitium.com/download/?force_cn=true</a>"
};
...
nkoreaTest.survey = [{
  ...
  "options": [{ "optionTag": "A", "optionText": "西方白領風格的女式工作西裝", "imagePath": "img/dressA.png" }, { "optionTag": "B", "optionText": "深色樸素的長衣＋長褲", "imagePath": "img/dressB.png" }, { "optionTag": "C", "optionText": "修身連衣裙＋短款上衣", "imagePath": "img/dressC.png" }, { "optionTag": "D", "optionText": "鮮豔的朝鮮民族服飾", "imagePath": "img/dressD.png" }],
  "correctOptionTag": "C",
  ...
  "optionContainsImage": false,
  "options": [{ "optionTag": "A", "optionText": "玩遊戲" }, { "optionTag": "B", "optionText": "學習領袖思想" }, { "optionTag": "C", "optionText": "看AV" }, { "optionTag": "D", "optionText": "毫無壓力，以上皆可" }],
  "correctOptionTag": "D",
  ...
  "optionContainsImage": false,
  "options": [{ "optionTag": "A", "optionText": "《將軍與水兵》：我們的船艦！尋找著敬愛的將軍！" }, { "optionTag": "B", "optionText": "《沒有你就沒有祖國》：沒有你就沒有我們！沒有你就沒有祖國！" }, { "optionTag": "C", "optionText": "《春天年年到人間》：百花爭豔百花爭豔，我們失去祖國沒有春天……" }, { "optionTag": "D", "optionText": "《腳步》：擦擦擦擦擦的腳步聲！我們金將軍的腳步聲！" }],
  "correctOptionTag": "D",
...
//# sourceMappingURL=data_hant-compiled.js.map