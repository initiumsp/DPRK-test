...
nkoreaTest.text = {
  ...
  marketingInfoboxInnerHTML: "<span style=\"color: red\"><strong>「端」APP：</strong>" + "<a href=\"https://theinitium.com/download/\" style=\"color: red\" target=\"_blank\">https://theinitium.com/download</a>" + "</span>" + "<br />" + "<strong>「端」网：</strong><a href=\"https://theinitium.com/\" target=\"_blank\">theinitum.com</a>" + "<br />" + "<strong>「端」报：</strong>香港发行，逢周五出版" + "<br />" + "<strong>端app：（中国内地用户）</strong>" + "<a href=\"https://theinitium.com/download/?force_cn=true\" target=\"_blank\">" + "https://theinitium.com/download/?force_cn=true</a>"
};
...
nkoreaTest.survey = [{
  ...
  "options": [{ "optionTag": "A", "optionText": "46" }, { "optionTag": "B", "optionText": "96" }, { "optionTag": "C", "optionText": "不计其数" }],
  "correctOptionTag": "B",
  ...
  "optionContainsImage": false,
  "options": [{ "optionTag": "A", "optionText": "3岁" }, { "optionTag": "B", "optionText": "13岁" }, { "optionTag": "C", "optionText": "23岁" }],
  "correctOptionTag": "A",
  ...
  "options": [{ "optionTag": "A", "optionText": "西方白领风格的女式工作西装", "imagePath": "img/dressA.png" }, { "optionTag": "B", "optionText": "深色朴素的长衣＋长裤", "imagePath": "img/dressB.png" }, { "optionTag": "C", "optionText": "修身连衣裙＋短款上衣", "imagePath": "img/dressC.png" }, { "optionTag": "D", "optionText": "鲜艳的朝鲜民族服饰", "imagePath": "img/dressD.png" }],
  "correctOptionTag": "C",
  ...
  "optionContainsImage": false,
  "options": [{ "optionTag": "A", "optionText": "玩游戏" }, { "optionTag": "B", "optionText": "学习领袖思想" }, { "optionTag": "C", "optionText": "看AV" }, { "optionTag": "D", "optionText": "毫无压力，以上皆可" }],
  "correctOptionTag": "D",
  ...
  "optionContainsImage": false,
  "options": [{ "optionTag": "A", "optionText": "《将军与水兵》：我们的船舰！寻找著敬爱的将军！" }, { "optionTag": "B", "optionText": "《没有你就没有祖国》：没有你就没有我们！没有你就没有祖国！" }, { "optionTag": "C", "optionText": "《春天年年到人间》：百花争豔百花争豔，我们失去祖国没有春天……" }, { "optionTag": "D", "optionText": "《脚步》：擦擦擦擦擦的脚步声！我们金将军的脚步声！" }],
  "correctOptionTag": "D",
...
//# sourceMappingURL=data_hans-compiled.js.map